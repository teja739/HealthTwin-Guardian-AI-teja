      ...
      {appState === 'signing-in' && (
        ...
        >
          <div className="text-center space-y-5">
            ...
            <div>
              <h3 className="text-sm font-display font-bold text-white">Authenticating with Google</h3>
              <p className="text-xs text-slate-400 mt-1">Securely verifying your identity...</p>
            </div>
          </div>
        </motion.div>
      )}
